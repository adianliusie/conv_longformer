...
model_parser.add_argument('--transformer', default='bert',    type=str,  help='select transformer (e.g. bert, roberta etc.)')
...
model_parser.add_argument('--window_len',  default=[3,3],      type=int,  help='context window',   nargs=2)
